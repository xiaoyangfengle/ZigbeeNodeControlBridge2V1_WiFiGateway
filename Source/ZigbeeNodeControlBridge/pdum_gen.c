...
PRIVATE uint8 s_au8apduControlInstance0Storage[82];
PRIVATE uint8 s_au8apduControlInstance1Storage[82];
PRIVATE uint8 s_au8apduControlInstance2Storage[82];
PRIVATE uint8 s_au8apduControlInstance3Storage[82];
PUBLIC pdum_tsAPduInstance s_asapduControlInstances[4] = {
    { s_au8apduControlInstance0Storage, 0, 0, 1 },
    { s_au8apduControlInstance1Storage, 0, 0, 1 },
    { s_au8apduControlInstance2Storage, 0, 0, 1 },
    { s_au8apduControlInstance3Storage, 0, 0, 1 },
};
...
PUBLIC pdum_tsAPduInstance s_asapdujumboInstances[2] = {
    { s_au8apdujumboInstance0Storage, 0, 0, 2 },
    { s_au8apdujumboInstance1Storage, 0, 0, 2 },
};
...
extern pdum_tsAPdu s_asAPduPool[3];
...
PUBLIC void PDUM_vInit(void)
{
    ...
    pdum_vAPduInit(s_asAPduPool, 3, NULL);
}
